...
if __name__ == "__main__":
    ...
    parser.add_argument('--output', metavar='filename.pdf', default='worksheet22.pdf',
                        help='Output file to the given filename '
                             '(default: worksheet1.pdf)')
    args = parser.parse_args()

    args.type = 'mix'
    args.digits = 7
    args.question_count = 100
    args.output = 'division_questions.pdf'
